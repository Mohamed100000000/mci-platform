...
class GenerationJobStatus(str, enum.Enum):
    """حالة الطلب الأب (job) — الذي ينقسم لعدة tasks صغيرة قابلة لإعادة
    المحاولة فرديًا. هذا هو أساس دعم pause/resume/retry في المرحلة 2B."""
...
class GenerationTaskStatus(str, enum.Enum):
    ...
    COMPLETED = "completed"
    FAILED = "failed"
    SKIPPED = "skipped"  # يُستخدم عند إيقاف job مؤقتًا فتُتخطى المهام غير المبدوءة بعد
